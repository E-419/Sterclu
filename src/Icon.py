...
#			)
	...
	def resource(fileName=None, fullpath = None):
		if fileName:
			...
			if fullpath:
				...
				fileName = os.path.join(str(p.parent), 'res', imageName)
			else:
	...
	def appIcon(fullpath = None):
		# https://stackoverflow.com/questions/16081201/setting-application-icon-in-my-python-tk-base-application-on-ubuntu
